...
import com.thanospan.ngsi.v2.client.api.BatchOperations;
...
public class BatchOperationsExample {
    public static void main(String[] args) {
        ...
        BatchOperations batchOperations = new BatchOperations(apiClient);

        update(batchOperations);
//        query(batchOperations);
//        notify(batchOperations);
    }

    private static void update(BatchOperations batchOperations) {
...
//        parameters.put("options", "keyValues");
        ...
        HttpResponse<String> httpResponse = batchOperations.update(contentType, body, parameters).join();
        printHttpResponse(httpResponse);
    }

    private static void query(BatchOperations batchOperations) {
        HashMap<String, String> parameters = new HashMap<>();
...
//        parameters.put("options", "count");
        ...
        HttpResponse<String> httpResponse = batchOperations.query(contentType, body, parameters).join();
        printHttpResponse(httpResponse);
    }

    private static void notify(BatchOperations batchOperations) {
        HashMap<String, String> parameters = new HashMap<>();
//        parameters.put("options", "keyValues");
        String contentType = "application/json";
        ...
        HttpResponse<String> httpResponse = batchOperations.notify(contentType, body, parameters).join();
        printHttpResponse(httpResponse);
    }
